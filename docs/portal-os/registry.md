...
- `docs/portal-os/tranches/038-weekly-meeting-mobile-disclosure.md` — mobile/touch UX polish on the `/planning/meeting` cockpit (commitment "+N more" expandable disclosure, cadence-rail connector arrows hidden on narrow phones, batch-chip tap-to-expand pack breakdown); +meeting-mobile unit tests
