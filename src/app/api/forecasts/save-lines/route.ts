...
// ---------------------------------------------------------------------------
// Portal proxy: POST /api/forecasts/save-lines
//   -> API POST /api/v1/mutations/forecasts/save-lines (G.5)
// ---------------------------------------------------------------------------
...
export async function POST(req: Request): Promise<Response> {
  ...
  try {
    upstream = await fetch(
      `${API_BASE}/api/v1/mutations/forecasts/save-lines`,
      {
        method: "POST",
        headers: {
    ...
    return NextResponse.json(
      {
        error: "forecasts save-lines upstream unreachable",
