    ...
    return (
      <>
        <WorkflowHeader
          ...
          actions={
            <Link href="/forecast" className="btn btn-sm gap-1.5">
        ...
        {lines.length === 0 ? (
          <div className="p-5">
            <EmptyState
              ...
              description={
                isEditable
                  ? "This draft has no saved lines. Save operations require a lines array, so start with adding lines via the API or a seed flow (line-authoring UI is MVP-scoped)."
                  : "Nothing to show."
              }
            />
          </div>
